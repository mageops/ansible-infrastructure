...
### WARNING!!! PATCHED MODULE AHEAD! ####
# This module override an be removed once the PR is merged
# and we migrate to the appropriate version - 2.10.x at the soonest.
# Fixes: https://github.com/ansible/ansible/issues/68354
# This file was taken from ansible 2.7.16 and patched with:
# https://github.com/ansible/ansible/pull/68355
# /FS
        ...
        try:
            ...
            for origin in origins:
                origin = self.validate_origin(
                    client, all_origins.get(get_origin_key(origin), {}), origin, default_origin_path
                )
                all_origins[get_origin_key(origin)] = origin
