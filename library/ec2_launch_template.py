...
#
# Mageops modifications: add support for tagging launch_template
# tags: tag launch tempalte
# resource_tags: tag resources created by launch template
#
...
options:
  ...
  tags:
    type: dict
    description:
    - A set of key-value pairs to be applied to launch template
    - "Tag key constraints: Tag keys are case-sensitive and accept a maximum of 127 Unicode characters. May not begin with I(aws:)"
    - "Tag value constraints: Tag values are case-sensitive and accept a maximum of 255 Unicode characters."
  user_data:
    description: >
...
from ansible_collections.ansible.community.plugins.module_utils.aws.core import AnsibleAWSModule, is_boto3_error_code, get_boto3_client_method_parameters
from ansible_collections.ansible.community.plugins.module_utils.common.dict_transformations import camel_dict_to_snake_dict, snake_dict_to_camel_dict
from ansible_collections.ansible.community.plugins.module_utils.ec2 import ansible_dict_to_boto3_tag_list, AWSRetry, boto3_tag_list_to_ansible_dict, ansible_dict_to_boto3_tag_list
        ...
        template_params['tag_specifications'] = [
            {
                ...
                'tags': [
                    ...
                    in template_params['resource_tags'].items()
                ]
            }
            for r_type in ('instance', 'volume')
        ]
        del template_params['resource_tags']
